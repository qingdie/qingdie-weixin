...
module.exports = new(function() {
    ...
    this.oauth2 = async (app, code) => {
        ...
        if (u.nickname || r.scope == 'snsapi_base') return u;
    ...
    this.oauth2Token = async (app, code) => {
        if (app.component) {
            ...
            let caccess_token = await token.getComponentToken(app.component);
            url += '?' + util.toParam({
                appid: app.id,
                component_access_token: caccess_token.accessToken,
