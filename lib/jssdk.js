module.exports = new(function() {
    ...
    this.jsurl = function(app, url, scope) {
        if (app.component) {
            return `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${app.id}&redirect_uri=${encodeURIComponent(url)}&response_type=code&scope=${(scope || 'snsapi_base')}&state=STATE&component_appid=${app.component.appid}#wechat_redirect`;
        } else {
